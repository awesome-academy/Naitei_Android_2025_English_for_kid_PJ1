    ...
    val videoStories =
        listOf(
            VideoItem(
                ...
                videoId = "Oaw-d3r_gIc",
                thumbnailUrl = "https://i.ytimg.com/vi/Oaw-d3r_gIc/hqdefault.jpg",
            ),
            VideoItem(
                id = UUID.randomUUID().toString(),
            ...
            VideoItem(
                ...
                videoId = "oepRTA4s4XM",
                thumbnailUrl = "https://i.ytimg.com/vi/oepRTA4s4XM/hqdefault.jpg",
            ),
            VideoItem(
                id = UUID.randomUUID().toString(),
                title = "The magic paintbrush",
                videoId = "a3P5bX8gGYI",
                thumbnailUrl = "https://i.ytimg.com/vi/a3P5bX8gGYI/hqdefault.jpg",
            ),
            VideoItem(
                id = UUID.randomUUID().toString(),
                title = "The treasure map",
                videoId = "G9B3ZGZ0nw0",
                thumbnailUrl = "https://i.ytimg.com/vi/G9B3ZGZ0nw0/hqdefault.jpg",
            ),
            VideoItem(
                id = UUID.randomUUID().toString(),
                title = "The great race",
                videoId = "aU0OqbP4JD8",
                thumbnailUrl = "https://i.ytimg.com/vi/aU0OqbP4JD8/hqdefault.jpg",
            ),
            VideoItem(
                id = UUID.randomUUID().toString(),
                title = "The snowman",
                videoId = "dbLecFXK00I",
                thumbnailUrl = "https://i.ytimg.com/vi/dbLecFXK00I/hqdefault.jpg",
            ),
            VideoItem(
                id = UUID.randomUUID().toString(),
            ...
            VideoItem(
                ...
                videoId = "mQ0MWFe4gs0",
                thumbnailUrl = "https://i.ytimg.com/vi/mQ0MWFe4gs0/hqdefault.jpg",
            ),
            VideoItem(
                id = UUID.randomUUID().toString(),
                title = "The cold planet",
                videoId = "BpGrac0Vm7M",
                thumbnailUrl = "https://i.ytimg.com/vi/BpGrac0Vm7M/hqdefault.jpg",
            ),
            VideoItem(
                id = UUID.randomUUID().toString(),
                title = "The sneaky rabbit",
                videoId = "D25eKPWa-j0",
                thumbnailUrl = "https://i.ytimg.com/vi/D25eKPWa-j0/hqdefault.jpg",
            ),
            VideoItem(
                id = UUID.randomUUID().toString(),
