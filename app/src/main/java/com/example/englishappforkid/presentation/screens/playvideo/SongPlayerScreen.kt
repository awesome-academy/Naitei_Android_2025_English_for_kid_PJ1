...
fun songScreen(
    ...
    // Giả sử bạn đã có hàm getVideoById trong SongDataSource
    ...
    DisposableEffect(videoId) {
        ...
        onDispose {
            exoPlayer.stop() // Dừng hẳn khi thoát
        }
    }
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        if (isFullscreen) {
            ...
            // SỬA LỖI 1: Lấy danh sách đề xuất từ `SongDataSource.songs`
            val suggestedSongs =
                remember(videoId) {
            ...
            Column(
                ...
                Text(
                    text = "Next Songs", // Đổi thành "Next Songs" cho hợp lý
